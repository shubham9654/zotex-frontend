		...
		<>
		  ...
		  `}>
				...
				>
					...
					<input
						className="w-full !h-[45px] pr-5 m-0 text-xs inline-flex items-center outline-none border-none font-poppinsRegular"
						type="text"
				...
				>
					<ul className="px-1 py-1">
						{options.map((option) => (
							...
							>
								<span className="text-black font-medium font-poppins">{option}</span>
